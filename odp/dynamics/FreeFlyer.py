...
class FreeFlyer:
    ...
    def opt_dstb(self, t, state, spat_deriv):
        ...
        parSum1 = hcl.scalar(0, "parSum1")
        parSum2 = hcl.scalar(0, "parSum2")
        parSum1[0] = spat_deriv[2] * (self.A_front * hcl.cos(state[3]) + self.A_side * hcl.sin(state[3]))
        parSum2[0] = spat_deriv[3] * (self.A_front * hcl.sin(state[3]) - self.A_side * hcl.cos(state[3]))
